...
// monthName returns the month name or abbrev for the supplied month number
//
// INPUTS
// dt = date in question
// n  = number or chars.  If not present, provid the whole month name. If
//      provided and > 0, it means the number of characters of the month
//      name to return.
//------------------------------------------------------------------------------
function monthName(dt, n) {
    var monthNames = ["January", "February", "March", "April", "May", "June",
      "July", "August", "September", "October", "November", "December"];

    if (typeof n == "undefined") {
        return monthNames[dt];
    }
    if (n > 0) {
        return monthNames[dt].substr(0,n);
    }
    return "";
}
